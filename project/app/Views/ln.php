    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h3>laporan nota</h3>
            <form action="<?= base_url('home/tabeln') ?>" method="post">
              <div class="row">
                <div class="col">
                ...
                <div class="row">
                  ...
                  <div class="col" class="form-control">
                    <a href="<?= base_url('home/tabeln/')?>"><button type="print" class="btn btn-primary" ?>
                ...
                <form action="<?= base_url('home/tabeln') ?>" method="post">
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col" class="form-control">
                        <a href="<?= base_url('home/tabeln/')?>"><button type="print" class="btn btn-danger" ?>
                    ...
                    <form action="<?= base_url('home/tabeln') ?>" method="post">
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col" class="form-control">
                            <a href="<?= base_url('home/tabeln/')?>"><button type="print" class="btn btn-success" ?>
